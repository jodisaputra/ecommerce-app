                        ...
                        <div class="grid gap-y-4">
                            ...
                            <div>
                                <div class="flex justify-between items-center">
                                    ...
                                    <a wire:navigate class="text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
